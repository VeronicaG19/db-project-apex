...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(363518508961681040)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2559233049076338886)
,p_plugin_id=>wwv_flow_imp.id(363518508961681040)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2559233604088338887)
,p_plugin_id=>wwv_flow_imp.id(363518508961681040)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412168997158231950)
,p_plugin_id=>wwv_flow_imp.id(363518508961681040)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412165424066231947)
,p_plugin_id=>wwv_flow_imp.id(363518508961681040)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412168526249231950)
,p_plugin_id=>wwv_flow_imp.id(363518508961681040)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412165962538231948)
,p_plugin_id=>wwv_flow_imp.id(363518508961681040)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412166471053231948)
,p_plugin_id=>wwv_flow_imp.id(363518508961681040)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412166964814231948)
,p_plugin_id=>wwv_flow_imp.id(363518508961681040)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412156645730231942)
,p_plugin_id=>wwv_flow_imp.id(363518508961681040)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(412166471053231948)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2559233604088338887)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412157095549231942)
,p_plugin_attribute_id=>wwv_flow_imp.id(412156645730231942)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412157714666231943)
,p_plugin_attribute_id=>wwv_flow_imp.id(412156645730231942)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412158308311231943)
,p_plugin_attribute_id=>wwv_flow_imp.id(412156645730231942)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412152245137231939)
,p_plugin_id=>wwv_flow_imp.id(363518508961681040)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(412156645730231942)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412152786196231940)
,p_plugin_id=>wwv_flow_imp.id(363518508961681040)
,p_attribute_scope=>'COMPONENT'
...
,p_depending_on_attribute_id=>wwv_flow_imp.id(412152245137231939)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412153212748231940)
,p_plugin_id=>wwv_flow_imp.id(363518508961681040)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412151770779231939)
,p_plugin_id=>wwv_flow_imp.id(363518508961681040)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412153769281231940)
,p_plugin_id=>wwv_flow_imp.id(363518508961681040)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412154199073231941)
,p_plugin_attribute_id=>wwv_flow_imp.id(412153769281231940)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412154797856231941)
,p_plugin_attribute_id=>wwv_flow_imp.id(412153769281231940)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412155470803231941)
,p_plugin_attribute_id=>wwv_flow_imp.id(412153769281231940)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412156028653231942)
,p_plugin_attribute_id=>wwv_flow_imp.id(412153769281231940)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412159394240231944)
,p_plugin_id=>wwv_flow_imp.id(363518508961681040)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(412166964814231948)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2559233049076338886)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412164970404231947)
,p_plugin_id=>wwv_flow_imp.id(363518508961681040)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412162713256231946)
,p_plugin_id=>wwv_flow_imp.id(363518508961681040)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412158891970231943)
,p_plugin_id=>wwv_flow_imp.id(363518508961681040)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412159927964231944)
,p_plugin_id=>wwv_flow_imp.id(363518508961681040)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412163198819231946)
,p_plugin_id=>wwv_flow_imp.id(363518508961681040)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412163731675231946)
,p_plugin_attribute_id=>wwv_flow_imp.id(412163198819231946)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412164292993231947)
,p_plugin_attribute_id=>wwv_flow_imp.id(412163198819231946)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412160402377231944)
,p_plugin_id=>wwv_flow_imp.id(363518508961681040)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412160943749231945)
,p_plugin_attribute_id=>wwv_flow_imp.id(412160402377231944)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412161513094231945)
,p_plugin_attribute_id=>wwv_flow_imp.id(412160402377231944)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412162165905231945)
,p_plugin_attribute_id=>wwv_flow_imp.id(412160402377231944)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412167483234231949)
,p_plugin_id=>wwv_flow_imp.id(363518508961681040)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412167926138231949)
,p_plugin_attribute_id=>wwv_flow_imp.id(412167483234231949)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-Timeline--compact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412151199740231939)
,p_plugin_id=>wwv_flow_imp.id(363518508961681040)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2158371616299996578)
,p_plugin_id=>wwv_flow_imp.id(363518508961681040)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2272782979288260179)
,p_plugin_id=>wwv_flow_imp.id(363518508961681040)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2391814226262564620)
,p_plugin_id=>wwv_flow_imp.id(363518508961681040)
,p_name=>'Avatar Link'
