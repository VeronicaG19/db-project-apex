...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(363581741983681085)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2212140401780115562)
,p_plugin_id=>wwv_flow_imp.id(363581741983681085)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2212140956792115563)
,p_plugin_id=>wwv_flow_imp.id(363581741983681085)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412143974898231930)
,p_plugin_id=>wwv_flow_imp.id(363581741983681085)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412137843975231926)
,p_plugin_id=>wwv_flow_imp.id(363581741983681085)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412138375442231926)
,p_plugin_id=>wwv_flow_imp.id(363581741983681085)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412138812455231927)
,p_plugin_id=>wwv_flow_imp.id(363581741983681085)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412129027852231920)
,p_plugin_id=>wwv_flow_imp.id(363581741983681085)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(412138375442231926)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2212140956792115563)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412129518343231921)
,p_plugin_attribute_id=>wwv_flow_imp.id(412129027852231920)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412130157926231921)
,p_plugin_attribute_id=>wwv_flow_imp.id(412129027852231920)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412130752977231921)
,p_plugin_attribute_id=>wwv_flow_imp.id(412129027852231920)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412124590947231918)
,p_plugin_id=>wwv_flow_imp.id(363581741983681085)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(412129027852231920)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412125118245231918)
,p_plugin_id=>wwv_flow_imp.id(363581741983681085)
,p_attribute_scope=>'COMPONENT'
...
,p_depending_on_attribute_id=>wwv_flow_imp.id(412124590947231918)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412125613759231918)
,p_plugin_id=>wwv_flow_imp.id(363581741983681085)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412124186663231918)
,p_plugin_id=>wwv_flow_imp.id(363581741983681085)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412126150887231919)
,p_plugin_id=>wwv_flow_imp.id(363581741983681085)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412126650234231919)
,p_plugin_attribute_id=>wwv_flow_imp.id(412126150887231919)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412127244663231919)
,p_plugin_attribute_id=>wwv_flow_imp.id(412126150887231919)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412127849373231920)
,p_plugin_attribute_id=>wwv_flow_imp.id(412126150887231919)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412128415034231920)
,p_plugin_attribute_id=>wwv_flow_imp.id(412126150887231919)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412131867067231922)
,p_plugin_id=>wwv_flow_imp.id(363581741983681085)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(412138812455231927)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2212140401780115562)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412137314927231926)
,p_plugin_id=>wwv_flow_imp.id(363581741983681085)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412135091087231924)
,p_plugin_id=>wwv_flow_imp.id(363581741983681085)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412131372773231922)
,p_plugin_id=>wwv_flow_imp.id(363581741983681085)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412132306428231923)
,p_plugin_id=>wwv_flow_imp.id(363581741983681085)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412135643608231925)
,p_plugin_id=>wwv_flow_imp.id(363581741983681085)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412136130876231925)
,p_plugin_attribute_id=>wwv_flow_imp.id(412135643608231925)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412136743743231925)
,p_plugin_attribute_id=>wwv_flow_imp.id(412135643608231925)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412132809656231923)
,p_plugin_id=>wwv_flow_imp.id(363581741983681085)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412133332135231923)
,p_plugin_attribute_id=>wwv_flow_imp.id(412132809656231923)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412133936321231923)
,p_plugin_attribute_id=>wwv_flow_imp.id(412132809656231923)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412134488181231924)
,p_plugin_attribute_id=>wwv_flow_imp.id(412132809656231923)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412139381424231927)
,p_plugin_id=>wwv_flow_imp.id(363581741983681085)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412139876450231927)
,p_plugin_attribute_id=>wwv_flow_imp.id(412139381424231927)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412140464712231928)
,p_plugin_attribute_id=>wwv_flow_imp.id(412139381424231927)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412141026549231928)
,p_plugin_attribute_id=>wwv_flow_imp.id(412139381424231927)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412141649959231928)
,p_plugin_attribute_id=>wwv_flow_imp.id(412139381424231927)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412142207327231929)
,p_plugin_attribute_id=>wwv_flow_imp.id(412139381424231927)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412142851910231929)
,p_plugin_id=>wwv_flow_imp.id(363581741983681085)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412143319776231929)
,p_plugin_attribute_id=>wwv_flow_imp.id(412142851910231929)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412123600580231917)
,p_plugin_id=>wwv_flow_imp.id(363581741983681085)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2163803380886711362)
,p_plugin_id=>wwv_flow_imp.id(363581741983681085)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
