...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(363473760507681006)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412050700831231856)
,p_plugin_id=>wwv_flow_imp.id(363473760507681006)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412051214574231856)
,p_plugin_attribute_id=>wwv_flow_imp.id(412050700831231856)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412051841441231857)
,p_plugin_attribute_id=>wwv_flow_imp.id(412050700831231856)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412052388003231857)
,p_plugin_attribute_id=>wwv_flow_imp.id(412050700831231856)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412042222119231851)
,p_plugin_id=>wwv_flow_imp.id(363473760507681006)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(412050700831231856)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412042769222231851)
,p_plugin_id=>wwv_flow_imp.id(363473760507681006)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(412042222119231851)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412043235623231851)
,p_plugin_id=>wwv_flow_imp.id(363473760507681006)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412041755908231850)
,p_plugin_id=>wwv_flow_imp.id(363473760507681006)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412043775480231852)
,p_plugin_id=>wwv_flow_imp.id(363473760507681006)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412044222158231852)
,p_plugin_attribute_id=>wwv_flow_imp.id(412043775480231852)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412044800274231852)
,p_plugin_attribute_id=>wwv_flow_imp.id(412043775480231852)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412045436074231853)
,p_plugin_attribute_id=>wwv_flow_imp.id(412043775480231852)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412046069191231853)
,p_plugin_id=>wwv_flow_imp.id(363473760507681006)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412046538107231854)
,p_plugin_attribute_id=>wwv_flow_imp.id(412046069191231853)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412047120596231854)
,p_plugin_attribute_id=>wwv_flow_imp.id(412046069191231853)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412047724695231854)
,p_plugin_attribute_id=>wwv_flow_imp.id(412046069191231853)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412048315097231855)
,p_plugin_attribute_id=>wwv_flow_imp.id(412046069191231853)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412048901855231855)
,p_plugin_attribute_id=>wwv_flow_imp.id(412046069191231853)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412049530567231855)
,p_plugin_attribute_id=>wwv_flow_imp.id(412046069191231853)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412050141236231856)
,p_plugin_attribute_id=>wwv_flow_imp.id(412046069191231853)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412041231562231850)
,p_plugin_id=>wwv_flow_imp.id(363473760507681006)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2163524810754794758)
,p_plugin_id=>wwv_flow_imp.id(363473760507681006)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
