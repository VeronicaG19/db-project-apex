...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(363544563539681058)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2339323222008303581)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2339322666996303580)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412112683376231906)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412113098021231906)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412110675236231904)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412112149984231905)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412111178945231905)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412111611689231905)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412096636112231896)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(412111178945231905)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2339323222008303581)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412097155717231896)
,p_plugin_attribute_id=>wwv_flow_imp.id(412096636112231896)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412097785068231897)
,p_plugin_attribute_id=>wwv_flow_imp.id(412096636112231896)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412098362437231897)
,p_plugin_attribute_id=>wwv_flow_imp.id(412096636112231896)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412087548315231890)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(412096636112231896)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412088052493231891)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(412087548315231890)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412088511812231891)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412087029364231890)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412088994387231891)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412089562805231892)
,p_plugin_attribute_id=>wwv_flow_imp.id(412088994387231891)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412090105570231892)
,p_plugin_attribute_id=>wwv_flow_imp.id(412088994387231891)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412090709342231892)
,p_plugin_attribute_id=>wwv_flow_imp.id(412088994387231891)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412091350958231893)
,p_plugin_attribute_id=>wwv_flow_imp.id(412088994387231891)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412102344040231899)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(412111611689231905)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2339322666996303580)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412110089189231904)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412107933173231903)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412101831948231899)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412102795623231900)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412108454683231903)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412108897163231903)
,p_plugin_attribute_id=>wwv_flow_imp.id(412108454683231903)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412109575465231904)
,p_plugin_attribute_id=>wwv_flow_imp.id(412108454683231903)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412103356159231900)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412103849324231900)
,p_plugin_attribute_id=>wwv_flow_imp.id(412103356159231900)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412104436861231901)
,p_plugin_attribute_id=>wwv_flow_imp.id(412103356159231900)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412105036288231901)
,p_plugin_attribute_id=>wwv_flow_imp.id(412103356159231900)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412091919846231893)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412092387573231893)
,p_plugin_attribute_id=>wwv_flow_imp.id(412091919846231893)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412093054740231894)
,p_plugin_attribute_id=>wwv_flow_imp.id(412091919846231893)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412093627587231894)
,p_plugin_attribute_id=>wwv_flow_imp.id(412091919846231893)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412094284465231895)
,p_plugin_attribute_id=>wwv_flow_imp.id(412091919846231893)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412094884063231895)
,p_plugin_attribute_id=>wwv_flow_imp.id(412091919846231893)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412095485899231895)
,p_plugin_attribute_id=>wwv_flow_imp.id(412091919846231893)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412095987331231896)
,p_plugin_attribute_id=>wwv_flow_imp.id(412091919846231893)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412105670773231901)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412106183292231902)
,p_plugin_attribute_id=>wwv_flow_imp.id(412105670773231901)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412106713869231902)
,p_plugin_attribute_id=>wwv_flow_imp.id(412105670773231901)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412107314260231902)
,p_plugin_attribute_id=>wwv_flow_imp.id(412105670773231901)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412098967999231897)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412099481880231898)
,p_plugin_attribute_id=>wwv_flow_imp.id(412098967999231897)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412099992552231898)
,p_plugin_attribute_id=>wwv_flow_imp.id(412098967999231897)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412100589474231898)
,p_plugin_attribute_id=>wwv_flow_imp.id(412098967999231897)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412101262414231899)
,p_plugin_attribute_id=>wwv_flow_imp.id(412098967999231897)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412086522013231890)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2171996498212574368)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2171997757732578516)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2158402869538167635)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2159082170268250739)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2171994563145529382)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2171995896535543239)
,p_plugin_id=>wwv_flow_imp.id(363544563539681058)
