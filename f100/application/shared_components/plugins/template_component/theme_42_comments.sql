...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(363497296474681023)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2211954179126263587)
,p_plugin_id=>wwv_flow_imp.id(363497296474681023)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412078104748231879)
,p_plugin_id=>wwv_flow_imp.id(363497296474681023)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412080792029231881)
,p_plugin_id=>wwv_flow_imp.id(363497296474681023)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412077599498231879)
,p_plugin_id=>wwv_flow_imp.id(363497296474681023)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412069959100231874)
,p_plugin_id=>wwv_flow_imp.id(363497296474681023)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412075349213231878)
,p_plugin_id=>wwv_flow_imp.id(363497296474681023)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(412078604162231880)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2211954179126263587)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412075839984231878)
,p_plugin_attribute_id=>wwv_flow_imp.id(412075349213231878)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412076481934231878)
,p_plugin_attribute_id=>wwv_flow_imp.id(412075349213231878)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412077039837231879)
,p_plugin_attribute_id=>wwv_flow_imp.id(412075349213231878)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412070975875231875)
,p_plugin_id=>wwv_flow_imp.id(363497296474681023)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(412075349213231878)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412071418602231875)
,p_plugin_id=>wwv_flow_imp.id(363497296474681023)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(412070975875231875)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412071895499231876)
,p_plugin_id=>wwv_flow_imp.id(363497296474681023)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412070407980231875)
,p_plugin_id=>wwv_flow_imp.id(363497296474681023)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412072411976231876)
,p_plugin_id=>wwv_flow_imp.id(363497296474681023)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412072982366231876)
,p_plugin_attribute_id=>wwv_flow_imp.id(412072411976231876)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412073520715231877)
,p_plugin_attribute_id=>wwv_flow_imp.id(412072411976231876)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412074115125231877)
,p_plugin_attribute_id=>wwv_flow_imp.id(412072411976231876)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412074776820231877)
,p_plugin_attribute_id=>wwv_flow_imp.id(412072411976231876)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412078604162231880)
,p_plugin_id=>wwv_flow_imp.id(363497296474681023)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412079134329231880)
,p_plugin_id=>wwv_flow_imp.id(363497296474681023)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412079628886231880)
,p_plugin_attribute_id=>wwv_flow_imp.id(412079134329231880)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(412080243761231880)
,p_plugin_attribute_id=>wwv_flow_imp.id(412079134329231880)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(412069398056231874)
,p_plugin_id=>wwv_flow_imp.id(363497296474681023)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2163515697295814243)
,p_plugin_id=>wwv_flow_imp.id(363497296474681023)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2163515105790806786)
,p_plugin_id=>wwv_flow_imp.id(363497296474681023)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2163570729460788665)
,p_plugin_id=>wwv_flow_imp.id(363497296474681023)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2163722947173659436)
,p_plugin_id=>wwv_flow_imp.id(363497296474681023)
