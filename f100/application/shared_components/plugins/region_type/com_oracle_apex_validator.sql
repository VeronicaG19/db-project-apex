...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(14939745369228688602)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(15703500327070609720)
,p_plugin_id=>wwv_flow_imp.id(14939745369228688602)
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(1062827066491434949)
,p_plugin_id=>wwv_flow_imp.id(14939745369228688602)
,p_name=>'SOURCE_SQL'
,p_is_required=>false
...
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(15703501406920609721)
,p_plugin_id=>wwv_flow_imp.id(14939745369228688602)
