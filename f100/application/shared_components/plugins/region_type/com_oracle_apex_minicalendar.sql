...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(14880536694542222193)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(169918523919835381)
,p_plugin_id=>wwv_flow_imp.id(14880536694542222193)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(169918897083835389)
,p_plugin_id=>wwv_flow_imp.id(14880536694542222193)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(169920136546835423)
,p_plugin_id=>wwv_flow_imp.id(14880536694542222193)
,p_name=>'SOURCE_SQL'
...
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(169920814893835429)
,p_plugin_id=>wwv_flow_imp.id(14880536694542222193)
