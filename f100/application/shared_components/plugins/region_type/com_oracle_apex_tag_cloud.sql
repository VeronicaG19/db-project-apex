...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(18719372516044707684)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(662125910336412070)
,p_plugin_id=>wwv_flow_imp.id(18719372516044707684)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(662126331223412070)
,p_plugin_id=>wwv_flow_imp.id(18719372516044707684)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(662126718318412070)
,p_plugin_id=>wwv_flow_imp.id(18719372516044707684)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(662128938695412073)
,p_plugin_id=>wwv_flow_imp.id(18719372516044707684)
,p_name=>'SOURCE_SQL'
,p_is_required=>false
...
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(662129592416412074)
,p_plugin_id=>wwv_flow_imp.id(18719372516044707684)
