...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(14867998969665560188)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(57992580288563970)
,p_plugin_id=>wwv_flow_imp.id(14867998969665560188)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(57992983582563970)
,p_plugin_id=>wwv_flow_imp.id(14867998969665560188)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(57993346490563970)
,p_plugin_id=>wwv_flow_imp.id(14867998969665560188)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(57993756980563970)
,p_plugin_id=>wwv_flow_imp.id(14867998969665560188)
,p_attribute_scope=>'COMPONENT'
