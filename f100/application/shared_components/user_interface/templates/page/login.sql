...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(14864991282559727698)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411628883836231521)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411629298319231521)
,p_page_template_id=>wwv_flow_imp.id(14864991282559727698)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411629814236231522)
,p_page_template_id=>wwv_flow_imp.id(14864991282559727698)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411630342203231522)
,p_page_template_id=>wwv_flow_imp.id(14864991282559727698)
,p_name=>'Body Footer'
