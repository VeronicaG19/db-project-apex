...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(14865008305340727719)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411679485459231556)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411679961952231557)
,p_page_template_id=>wwv_flow_imp.id(14865008305340727719)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411680418352231557)
,p_page_template_id=>wwv_flow_imp.id(14865008305340727719)
