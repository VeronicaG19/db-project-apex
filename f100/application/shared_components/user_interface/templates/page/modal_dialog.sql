...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(14864998315927727706)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411655769160231540)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411656230058231540)
,p_page_template_id=>wwv_flow_imp.id(14864998315927727706)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411656692955231541)
,p_page_template_id=>wwv_flow_imp.id(14864998315927727706)
