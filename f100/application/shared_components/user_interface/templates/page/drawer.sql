...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(308400881674722402)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411599600446231500)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411600094691231501)
,p_page_template_id=>wwv_flow_imp.id(308400881674722402)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411600665908231501)
,p_page_template_id=>wwv_flow_imp.id(308400881674722402)
