...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(523718148250208276)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411790079372231641)
,p_plug_template_id=>wwv_flow_imp.id(523718148250208276)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411790547606231641)
,p_plug_template_id=>wwv_flow_imp.id(523718148250208276)
,p_name=>'Sub Regions'
