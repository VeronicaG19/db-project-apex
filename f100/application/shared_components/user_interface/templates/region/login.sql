...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14865025074778727748)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411853772092231689)
,p_plug_template_id=>wwv_flow_imp.id(14865025074778727748)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411854238100231689)
,p_plug_template_id=>wwv_flow_imp.id(14865025074778727748)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411854691427231690)
,p_plug_template_id=>wwv_flow_imp.id(14865025074778727748)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411855252394231690)
,p_plug_template_id=>wwv_flow_imp.id(14865025074778727748)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411855699534231690)
,p_plug_template_id=>wwv_flow_imp.id(14865025074778727748)
,p_name=>'Sub Regions'
