...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(15241552809437785215)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411893592399231721)
,p_plug_template_id=>wwv_flow_imp.id(15241552809437785215)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411894121341231722)
,p_plug_template_id=>wwv_flow_imp.id(15241552809437785215)
,p_name=>'Tabs'
