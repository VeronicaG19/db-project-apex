...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14865021534519727741)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411782556999231635)
,p_plug_template_id=>wwv_flow_imp.id(14865021534519727741)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411783037185231635)
,p_plug_template_id=>wwv_flow_imp.id(14865021534519727741)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411783530509231636)
,p_plug_template_id=>wwv_flow_imp.id(14865021534519727741)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411783992437231636)
,p_plug_template_id=>wwv_flow_imp.id(14865021534519727741)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411784585001231636)
,p_plug_template_id=>wwv_flow_imp.id(14865021534519727741)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
