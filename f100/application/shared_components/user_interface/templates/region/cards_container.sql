...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(701887288612470018)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411714491913231582)
,p_plug_template_id=>wwv_flow_imp.id(701887288612470018)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411715013594231583)
,p_plug_template_id=>wwv_flow_imp.id(701887288612470018)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411715532013231583)
,p_plug_template_id=>wwv_flow_imp.id(701887288612470018)
,p_name=>'Sub Regions'
