...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(363342810348680892)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411859575609231693)
,p_plug_template_id=>wwv_flow_imp.id(363342810348680892)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411860052077231694)
,p_plug_template_id=>wwv_flow_imp.id(363342810348680892)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411860570392231694)
,p_plug_template_id=>wwv_flow_imp.id(363342810348680892)
,p_name=>'Sub Regions'
