...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(363347158836680895)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411846916818231684)
,p_plug_template_id=>wwv_flow_imp.id(363347158836680895)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411847469674231684)
,p_plug_template_id=>wwv_flow_imp.id(363347158836680895)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(411847931662231684)
,p_plug_template_id=>wwv_flow_imp.id(363347158836680895)
,p_name=>'Button Start'
