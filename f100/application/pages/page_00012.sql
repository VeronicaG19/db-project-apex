...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(14656238764379367507)
...
,p_plug_template=>wwv_flow_imp.id(14865020522152727739)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(14732315760477155325)
...
,p_plug_required_role=>wwv_flow_imp.id(15681513576540687430)
,p_attribute_01=>'26'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(14936615970009740969)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(344171902651001845)
,p_name=>'User Counts'
,p_parent_plug_id=>wwv_flow_imp.id(14936615970009740969)
...
,p_query_row_template=>wwv_flow_imp.id(14865029283448727756)
,p_query_num_rows=>15
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(344171960777001846)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(344172115022001847)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(344172184587001848)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(344172335386001849)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(14732315646423155324)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(17812705598438857980)
...
,p_plug_display_point=>'SUB_REGIONS'
,p_list_id=>wwv_flow_imp.id(17812702992898856414)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(14865038329100727775)
,p_plug_required_role=>wwv_flow_imp.id(15681513576540687430)
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15849873429362747960)
...
,p_plug_new_grid_row=>false
,p_plug_new_grid_column=>false
,p_list_id=>wwv_flow_imp.id(15849867297379746840)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(14865038329100727775)
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(16352558281769834105)
...
,p_plug_new_grid_row=>false
,p_plug_new_grid_column=>false
,p_list_id=>wwv_flow_imp.id(16352197981029805441)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(14865038329100727775)
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(17807138638142317833)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(17807167434479787804)
,p_plug_name=>'Administration'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--scrollBody'
,p_component_template_options=>'#DEFAULT#:u-colors'
,p_plug_template=>wwv_flow_imp.id(14865025228821727749)
,p_plug_display_sequence=>10
,p_list_id=>wwv_flow_imp.id(17807140048671325710)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(14865038329100727775)
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(18010235139403692100)
,p_plug_name=>'Logging'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hiddenOverflow'
,p_component_template_options=>'#DEFAULT#:u-colors'
,p_plug_template=>wwv_flow_imp.id(14865025228821727749)
...
,p_plug_new_grid_row=>false
,p_plug_new_grid_column=>false
,p_list_id=>wwv_flow_imp.id(18741414838671518304)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(14865038329100727775)
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(14656238977192371203)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(14656238764379367507)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(14656239188274374476)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(17816933384456138734)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(15982425963248964103)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(14961033578477328032)
