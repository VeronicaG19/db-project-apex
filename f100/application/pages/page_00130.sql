...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(989877531224522453)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2874581969958433745)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(344680936646705554)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(989877531224522453)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(344680484671705553)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(344690682716705577)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(344681652883705554)
,p_name=>'P130_AC_ENABLED'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2874581969958433745)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(344682003670705556)
...
,p_lov=>'.'||wwv_flow_imp.id(344691051558705580)||'.'
,p_field_template=>wwv_flow_imp.id(272547545455805751)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(344682401469705556)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(344682763920705560)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(344685115656705573)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(344685562276705574)
,p_event_id=>wwv_flow_imp.id(344685115656705573)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(344686066028705574)
,p_event_id=>wwv_flow_imp.id(344685115656705573)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(344687378958705575)
,p_name=>'APPLY CHANGES WHEN AC ENABLED'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(344680936646705554)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(344687863685705575)
,p_event_id=>wwv_flow_imp.id(344687378958705575)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(344688290098705575)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(344688795641705575)
,p_event_id=>wwv_flow_imp.id(344688290098705575)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(344689280799705576)
,p_event_id=>wwv_flow_imp.id(344688290098705575)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(344689658062705576)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(344690170403705576)
,p_event_id=>wwv_flow_imp.id(344689658062705576)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SUBMIT_PAGE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(344686541325705574)
,p_name=>'Cancel Dialog'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(344680484671705553)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(344686988006705574)
,p_event_id=>wwv_flow_imp.id(344686541325705574)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(344683932104705572)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(344684349371705572)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(344684715955705573)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(344683541743705572)
