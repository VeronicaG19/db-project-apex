...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1111748879250271161)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(1111748969506271162)
,p_region_id=>wwv_flow_imp.id(1111748879250271161)
,p_chart_type=>'bar'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(1111749065367271163)
,p_chart_id=>wwv_flow_imp.id(1111748969506271162)
,p_seq=>10
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(1111749236203271164)
,p_chart_id=>wwv_flow_imp.id(1111748969506271162)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(1111749305269271165)
,p_chart_id=>wwv_flow_imp.id(1111748969506271162)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15875867935586741021)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15875868902894745417)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(15879753241996683336)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(15875867935586741021)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(15875869213323745423)
,p_name=>'P92_CATEGORY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(15875868902894745417)
,p_item_default=>'0'
,p_prompt=>'Category'
,p_source=>'0'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(15879743790180557466)
,p_name=>'P92_GEO'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(15875868902894745417)
,p_prompt=>'Geography'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(15876038214329066212)
,p_name=>'prod counts'
,p_event_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1111749551146271167)
,p_event_id=>wwv_flow_imp.id(15876038214329066212)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1111748879250271161)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(15879744358941576390)
,p_name=>'geo'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1111749445482271166)
,p_event_id=>wwv_flow_imp.id(15879744358941576390)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
