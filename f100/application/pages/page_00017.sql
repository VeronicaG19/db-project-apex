...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(17798872590390740151)
...
,p_list_id=>wwv_flow_imp.id(17798872103048740135)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(14865038329100727775)
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(17811374736588800691)
,p_plug_name=>'Reports'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(17811377834726812943)
...
,p_list_id=>wwv_flow_imp.id(17811376340136805012)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(14865038329100727775)
);
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(17818175496294092907)
